    ...
    <div className="flex items-center justify-center min-h-screen">
      <div className="text-center space-y-8">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSffyUeZY6DtVe_BRm2h1LMcuMvOFdqfky17ZE_yIGgg3RUfvQ/viewform" target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-blue-800 text-white rounded hover:bg-blue-700">
            Sign Up
          </a>
        </div>
      </div>
